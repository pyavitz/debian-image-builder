...
```
#### Notes
* **Radxa Zero:** [Maskrom](https://wiki.radxa.com/Zero/dev/maskrom#Enable_maskrom) \ [Fastboot](https://wiki.radxa.com/Zero/dev/u-boot#Run_U-boot) \ [Wifi Hack](https://github.com/pyavitz/debian-image-builder/tree/feature/patches/amlogic/rzero/wifi)
