...
help:
	...
	@echo "  Amlogic:    lepotato odroidc4 odroidhc4 odroidn2 odroidn2l odroidn2plus"
	@echo "              radxazero x96air"
	...
	@echo ""
	@echo "  WIP:        cubietruck cuboxi bananapim2zero bananapim5 bananapip2zero"
